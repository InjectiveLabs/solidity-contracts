...
interface IExchangeModule {
    ...
    struct TrimmedDerivativeLimitOrder {
        uint256 price; // API FORMAT: human-readable scaled by 18 decimals (e.g., 50123450000000000000000 = 50123.45)
        uint256 quantity; // API FORMAT: human-readable scaled by 18 decimals (e.g., 5250000000000000000 = 5.25)
        uint256 margin; // API FORMAT: human-readable scaled by 18 decimals (e.g., 1000750000000000000000 = 1000.75)
        uint256 fillable; // the amount of the quantity remaining fillable - API FORMAT: human-readable scaled by 18 decimals
        bool isBuy;
        string orderHash;
        string cid;
    }
    ...
    struct CreateDerivativeMarketOrderResponse {
        ...
        uint256 quantity; // API FORMAT: human-readable scaled by 18 decimals (e.g., 5250000000000000000 = 5.25)
        uint256 price; // API FORMAT: human-readable scaled by 18 decimals (e.g., 50123450000000000000000 = 50123.45)
        uint256 fee; // API FORMAT: human-readable scaled by 18 decimals
        uint256 payout; // API FORMAT: human-readable scaled by 18 decimals
        uint256 deltaExecutionQuantity; // API FORMAT: human-readable scaled by 18 decimals
        uint256 deltaExecutionMargin; // API FORMAT: human-readable scaled by 18 decimals
        uint256 deltaExecutionPrice; // API FORMAT: human-readable scaled by 18 decimals
        bool deltaIsLong;
    }
    ...
    struct TrimmedSpotLimitOrder {
        uint256 price; // API FORMAT: human-readable scaled by 18 decimals (e.g., 1050000000000000000 = 1.05)
        uint256 quantity; // API FORMAT: human-readable scaled by 18 decimals (e.g., 100250000000000000000 = 100.25)
        uint256 fillable; // the amount of the quantity remaining fillable - API FORMAT: human-readable scaled by 18 decimals
        bool isBuy;
        string orderHash;
        string cid;
